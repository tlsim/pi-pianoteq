...
setup(
    ...
    description="An rtmidi based remote control for Pianoteq",  # Optional
    ...
    url="https://github.com/tlsim/pi-pianoteq",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Tom Simmons",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="info@tomsimmons.dev",  # Optional
    ...
    keywords="pianoteq rtmidi",  # Optional
    ...
    # MANIFEST.in as well.
    package_data={"pi_pianoteq": ["instruments.json", "pi_pianoteq.conf"]},  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/tlsim/pi-pianoteq/issues",
        "Source": "https://github.com/tlsim/pi-pianoteq/",
    },
)
