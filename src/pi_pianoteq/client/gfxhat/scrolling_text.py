...
class ScrollingText:
    ...
    def __init__(self, text, font, max_width, scroll_speed=1, update_interval=0.4, initial_delay=1.0, wrap_gap=20):
        """
        ...
        Args:
            ...
            update_interval: Seconds between updates (default: 0.4)
