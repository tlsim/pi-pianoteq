...
scp dist/pi_pianoteq-1.3.0-py3-none-any.whl $REMOTE:/tmp/pi_pianoteq-1.3.0-py3-none-any.whl
...
"\$VENV_PATH/bin/pip" install --upgrade --force-reinstall --no-deps /tmp/pi_pianoteq-1.3.0-py3-none-any.whl
